...
function BankImportModal({
  ...
  async function runImport() {
    ...
    // Fail-closed guard — importAllowed is the single canonical source of truth
    // (set by postProcessBankTransactions; encapsulates reconciliationOk and
    // extractionComplete). The row-level needsReview check is a client-side
    // safety net for rows whose flags were added after the server gate ran.
    const canImport =
