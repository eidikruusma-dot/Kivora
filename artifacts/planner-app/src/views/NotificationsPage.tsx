import { Bell, Clock, Calendar, Repeat } from 'lucide-react'
...
const ICON_MAP = { clock: Clock, calendar: Calendar, repeat: Repeat } as const
    ...
    <div className="max-w-2xl mx-auto px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-[#E8E6E0] overflow-hidden">
        {notifications.length === 0 ? (
          <p className="px-6 py-12 text-center text-sm text-[#94A3B8]">{t('notif.empty', lang)}</p>
        ) : (
          notifications.map((n) => {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {!n.read && (
                      <span className="flex-shrink-0 rounded-full" style={{ backgroundColor: '#6F5AE8', width: '7px', height: '7px' }} />
                    )}
                  </div>
