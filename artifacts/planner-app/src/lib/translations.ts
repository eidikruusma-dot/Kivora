...
const dict: Record<AppLang, Record<TranslationKey, string>> = {
    et: {
        ...
        "goals.empty.title": "Sea oma esimene eesmärk",
        "goals.empty.body": "Alusta väikesest sammust — Kivora aitab sul edenemist jälgida.",
        ...
        "help.faq.a3": "Logi sisse sama Kivora kontoga igal seadmel. Kivora hoiab sinu andmed automaatselt sünkroonis kõigi seadmete vahel.",
        ...
        "backup.history.habits": "Harjumused on samuti varundatud.",
        ...
        "school.action.openMoodle": "Ava veebileht",
    ...
    en: {
        ...
        "goals.empty.title": "Set your first goal",
        "goals.empty.body": "Start with one small step — Kivora will help you track your progress.",
        ...
        "help.faq.a3": "Sign in with the same Kivora account on each device. Kivora automatically keeps your data in sync across all your devices.",
        ...
        "backup.history.habits": "Habits are included in backups too.",
        ...
        "school.action.openMoodle": "Open website",
